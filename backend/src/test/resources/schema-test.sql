...
CREATE TABLE IF NOT EXISTS trade (
    ...
    CONSTRAINT fk_trade_portfolio FOREIGN KEY (portfolio_id) REFERENCES portfolio(id) ON DELETE CASCADE,
    CONSTRAINT fk_trade_customer  FOREIGN KEY (customer_id)  REFERENCES customer(id)  ON DELETE CASCADE
);
